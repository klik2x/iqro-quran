            ...
            <div className="w-full max-w-sm text-center">
                ...
                <div className="bg-white dark:bg-dark-blue-card p-8 rounded-2xl shadow-lg space-y-6">
                    ...
                    >
                        ...
                        {t('loginWithGoogle' as TranslationKeys)}
                    </button>
                ...
                <p className="mt-6 text-xs text-gray-500 dark:text-gray-400">
                    Dengan melanjutkan, Anda menyetujui <Link to="/terms" className="text-emerald-dark dark:text-emerald-light hover:underline">{t('termsOfService' as TranslationKeys)}</Link> dan <Link to="/privacy" className="text-emerald-dark dark:text-emerald-light hover:underline">{t('privacyPolicy' as TranslationKeys)}</Link> kami.
                </p>
            </div>
        </div>
    );
